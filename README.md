...
> **适用场景**：网络安全课程实验、毕业设计演示、攻防原理可视化教学、个人安全研究。
...
> **Intended for**: network security coursework, thesis defense demos, attack-defense principle visualization, and personal security research.
